...
var Config = /** @class */ (function () {
    function Config() {
        ...
        this.orderStartTime = "12:00";
        this.orderEndTime = "22:30";
        this.orderStartEndTimeError = "Мы принимаем заказы с 12:00 до 22:30";
        this.minOrderPreparationTimeMinutes = 90;
        this.minTimeError = "Для приготовления заказа нужно минимум 90 минут.";
...
var DeliveryValidation = /** @class */ (function () {
    ...
    DeliveryValidation.prototype.onReady = function () {
        ...
        this.getVisibilityToggle().each(function () { jQuery(_this).on('change', updateFieldsVisibility); });
